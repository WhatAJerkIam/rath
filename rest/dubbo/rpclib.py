...
from rpcerror import NoProvider, ConnectionFail, dubbo_client_errors, InternalError
...
class DubboClient(object):
    ...
    def call(self, method, *args, **kwargs):
        ...
        for key in provides:
            service_url = provides[key]
            ip_port = key
        print("http://{0}{1}".format(ip_port, service_url.path))
